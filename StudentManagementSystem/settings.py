...
SECRET_KEY = 'django-insecure-+^l=8o753v-yta1q+niky@y5nc=1z=4*y1@+0&^)+5qnnt2%r%'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'chistodliauchebi@gmail.com'  # Ваш email
EMAIL_HOST_PASSWORD = 'C3Hc8S3VdImZp1ySPqIctaYRiMxqIYGf'    # Пароль от email
